...
export const grade = async (studentId: string) =>
  Student.aggregate([
    ...
    // TODO: Group information for the student with the given ObjectId alongside an overall grade calculated using the $avg operator
    {
      // Your code here
      $group: {
        //This is the same as the $group operator in MongoDB. It groups documents by the specified field(s) and performs an aggregation operation on them.
        _id: "$_id", // This is the unique identifier for the student.
        overallGrade: { $avg: "$assignments.score" }, // This calculates the average grade of all assignments for the student.
      },
    },
  ]);
